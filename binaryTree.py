...
class BinaryTree:
    ...
    #def delete(self,key):
        # cuand encuentre el nodo que contiene el dato que quiero borrar lo direcciono al arbol izuierdo y 
        # en ese arbol izquierdo busco el maximo para que ese ahora sea mu sucesor 
    ...
    #esta funcion solo permite saber 
